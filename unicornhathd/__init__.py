...
def set_pixel(x, y, r, g, b):
    ...
    :param y: Vertical position from 0 to 15
    :param r: Amount of red from 0 to 255
    :param g: Amount of green from 0 to 255
    :param b: Amount of blue from 0 to 255
...
def set_pixels(buf):
    """Sets the buffer values all at once for speed.

    :param buf: New buffer to set.
...
def set_row(pos: int, rgb_values: list):
    global _buf
    _buf[pos] = rgb_values


def set_pixel_rgb(x, y, rgb):
    global _buf
    _buf[x][y] = rgb
